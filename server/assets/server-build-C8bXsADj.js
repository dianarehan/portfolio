...
const sprites = "/assets/icons-DIo2gwnz.svg";
...
const github = "dianarehan";
const linkedin = "diana-rehan";
const repo = "https://github.com/HamishMW/portfolio";
const itch = "https://dianarehan.itch.io/";
...
function ProjectHeader({
  ...
  linkLabel = "Play the Game on itch.io",
  url: url2,
  roles: roles2,
  className
}) {
...
const Carousel = lazy(
  () => import("./index-DwBSLlnB.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-BUxcxird.js").then((module) => ({ default: module.Armor })));
...
const roles$1 = ["3D Modelling", "Texturing", "Graphic Design"];
const meta$8 = () => {
...
const backgroundSprLarge = "/assets/free-background-CoE0WE1q.png";
...
const tempoDashGIF = "/assets/GIF-showcase-DuAgSKcx.gif";
lazy(() => import("./earth-CofwPUxd.js").then((module) => ({ default: module.Earth })));
lazy(
  () => import("./earth-CofwPUxd.js").then((module) => ({ default: module.EarthSection }))
);
const title$5 = "Tempo Dash 3D rhythm game";
const description$3 = "Get ready to dash to the rhythm in Tempo Dash, a fast-paced 3D rhythm game built in Unity! Hit tempo-based arrows, move with precision, and vibe with 3 music tracks that get your heart pumping.";
const meta$7 = () => {
...
const SmartSparrow = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { as: "h5", children: "Featuring Tame Impala XD" }),
        /* @__PURE__ */ jsx(
          ProjectImage,
          {
            raised: true,
            srcSet: `${tempoDashGIF} 1280w, ${imageSprLessonBuilderDarkLarge} 2560w`,
            width: 1280,
            height: 800,
...
const tempoDashTexture = "/assets/tempodash-game-DCpG3dQG.png";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-Dp8Y89gs.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsxs(Text, { className: styles$3.description, "data-visible": visible, size: "l", as: "p", children: [
    ...
    " ",
    /* @__PURE__ */ jsx(Link, { href: "https://www.it-qan.com/", children: "ITQAN for smart solutions" }),
    ". My portfolio includes personal games developed during game jams in my free time, alongside professional VR interaction scenarios created as part of my work. If you’re interested in the tools and software I use check out my ",
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$3.content, ref: nodeRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$3.column, children: /* @__PURE__ */ jsxs("div", { className: styles$3.tag, "aria-hidden": true, children: [
          /* @__PURE__ */ jsx(
            Divider,
            {
              notchWidth: "64px",
        ...
        /* @__PURE__ */ jsx("div", { className: styles$3.column, children: /* @__PURE__ */ jsx(ProfileText, { visible: visible2, titleId }) })
      ] }) })
    }
  );
};
...
const Model = lazy(
  () => import("./index-BdfacaaQ.js").then((module) => ({ default: module.Model }))
);
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles.uses, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Design and Manage" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          ...
          /* @__PURE__ */ jsxs(ListItem, { children: [
            ...
            " ",
            /* @__PURE__ */ jsx(Link, { href: "https://trello.com/", children: "Trello" }),
          ...
          /* @__PURE__ */ jsxs(ListItem, { children: [
            ...
            " for really quick designs for my games when puplishing out a game jam on ",
            /* @__PURE__ */ jsx(Link, { href: "https://dianarehan.itch.io/", children: "itch.io" })
          ] })
        ] }) })
      ] }) }) }),
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        ...
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          /* @__PURE__ */ jsxs(ListItem, { children: [
            "I basically use ",
            /* @__PURE__ */ jsx(Link, { href: "https://unity.com/products/unity-engine", children: "Unity" }),
            " as my current game engine, hopefully I’ll be able to switch to ",
            /* @__PURE__ */ jsx(Link, { href: "https://www.unrealengine.com/en-US/", children: "Unreal Engine" }),
            " in the future."
          ] }),
          /* @__PURE__ */ jsx(ListItem, { children: "Brave is my main browser for both development and general use." }),
          /* @__PURE__ */ jsxs(ListItem, { children: [
            "I often work with the ",
            /* @__PURE__ */ jsx(Link, { href: "https://www.mongodb.com/mern-stack", children: "MERN stack" }),
            " (MongoDB, Express.js, React, Node.js) for full-stack web development projects."
          ] })
        ] }) })
      ] }) }) })
    ] }),
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BbSqk_uA.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-jaZZsKSa.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/image-r0uhSCY5.js", "/assets/error-B2A4izMQ.js", "/assets/useScrollToHash-CjKjKrd-.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/config-o_T4FUZY.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/image-cNt8ozvO.css", "/assets/error-Cq_yTnRj.css", "/assets/root-Ci9I8dx3.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-BC8mxgZX.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-D0ZPyWWq.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/image-r0uhSCY5.js", "/assets/meta-BHfq3CQz.js", "/assets/useParallax-J5iiBMOU.js", "/assets/project-bNP1uG9K.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Dgt82hGY.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-YblCpcvN.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.tempo-dash": { "id": "routes/projects.tempo-dash", "parentId": "root", "path": "projects/tempo-dash", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CCKlPzRm.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/image-r0uhSCY5.js", "/assets/meta-BHfq3CQz.js", "/assets/useParallax-J5iiBMOU.js", "/assets/project-bNP1uG9K.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css"] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-0VklfAbU.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/meta-BHfq3CQz.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/divider-CGYQcqhA.js", "/assets/image-r0uhSCY5.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/divider-BGrE333F.css", "/assets/image-cNt8ozvO.css", "/assets/route-Cl8BF6JV.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CYRDYBLb.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/image-r0uhSCY5.js", "/assets/meta-BHfq3CQz.js", "/assets/useParallax-J5iiBMOU.js", "/assets/slice-app-CvtkH059.js", "/assets/project-bNP1uG9K.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Cvnrim9f.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BOd2RvHC.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/divider-CGYQcqhA.js", "/assets/meta-BHfq3CQz.js", "/assets/image-r0uhSCY5.js", "/assets/useParallax-J5iiBMOU.js", "/assets/useScrollToHash-CjKjKrd-.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/link-CBbg32KX.js", "/assets/list-Cdt8vaGT.js", "/assets/index-L_4ix5aQ.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/divider-BGrE333F.css", "/assets/meta-_6KA8l-u.css", "/assets/image-cNt8ozvO.css", "/assets/link-0uB5mRf5.css", "/assets/list-Bzmr24nT.css", "/assets/route-CIB4zeEr.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BuN8MhKO.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/config-o_T4FUZY.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/divider-CGYQcqhA.js", "/assets/meta-BHfq3CQz.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/divider-BGrE333F.css", "/assets/meta-_6KA8l-u.css", "/assets/route-CKif1uL8.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Cs-xJz7e.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/slice-app-CvtkH059.js", "/assets/meta-BHfq3CQz.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useScrollToHash-CjKjKrd-.js", "/assets/divider-CGYQcqhA.js", "/assets/link-CBbg32KX.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-C4aNgxLu.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/divider-BGrE333F.css", "/assets/link-0uB5mRf5.css", "/assets/route-D3R5eEKe.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-C3dl3pE6.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/image-r0uhSCY5.js", "/assets/meta-BHfq3CQz.js", "/assets/useParallax-J5iiBMOU.js", "/assets/link-CBbg32KX.js", "/assets/list-Cdt8vaGT.js", "/assets/project-bNP1uG9K.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/link-0uB5mRf5.css", "/assets/list-Bzmr24nT.css", "/assets/image-cNt8ozvO.css", "/assets/project-CMTDR1YT.css", "/assets/route-Eck0UXw8.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-C1VFRjnU.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useInViewport-BTZhtN2x.js", "/assets/image-BvwpLhe9.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/image-r0uhSCY5.js", "/assets/error-B2A4izMQ.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/image-cNt8ozvO.css", "/assets/error-Cq_yTnRj.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Cs-xJz7e.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-DVwRxDUd.js", "/assets/config-o_T4FUZY.js", "/assets/index-CUTzbYqQ.js", "/assets/use-spring-f-GHBzor.js", "/assets/slice-app-CvtkH059.js", "/assets/meta-BHfq3CQz.js", "/assets/decoder-text-CD0OmCfF.js", "/assets/theme-provider-CqGlrrJY.js", "/assets/useScrollToHash-CjKjKrd-.js", "/assets/divider-CGYQcqhA.js", "/assets/link-CBbg32KX.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-C4aNgxLu.js"], "css": ["/assets/heading-CXQ7GA1i.css", "/assets/meta-_6KA8l-u.css", "/assets/decoder-text-ZXA-E-72.css", "/assets/divider-BGrE333F.css", "/assets/link-0uB5mRf5.css", "/assets/route-D3R5eEKe.css"] } }, "url": "/assets/manifest-ae078deb.js", "version": "ae078deb" };
...
const routes = {
  ...
  "routes/projects.tempo-dash": {
    id: "routes/projects.tempo-dash",
    parentId: "root",
    path: "projects/tempo-dash",
    index: void 0,
    caseSensitive: void 0,
    module: route4
  },
