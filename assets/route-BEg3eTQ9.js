...
`,Le="_canvas_n18ih_1",Ve={canvas:Le},T={stiffness:30,damping:20,mass:2},Ne=t=>{const{theme:c}=G(),h=n.useRef(Date.now()),f=n.useRef(),a=n.useRef(),r=n.useRef(),i=n.useRef(),l=n.useRef(),y=n.useRef(),z=n.useRef(),b=n.useRef(),x=n.useRef(),s=n.useRef(),m=A(),d=O(f),_=X(),P=k(0,T),w=k(0,T);return n.useEffect(()=>{const{innerWidth:o,innerHeight:u}=window;return a.current=new Y(.8,.5),r.current=new J({canvas:f.current,antialias:!1,alpha:!0,powerPreference:"high-performance"}),r.current.setSize(o,u),r.current.setPixelRatio(1),r.current.outputColorSpace=K,i.current=new Q(54,o/u,.1,100),i.current.position.z=52,l.current=new Z,b.current=new ee,b.current.onBeforeCompile=v=>{z.current=ne.merge([v.uniforms,{time:{type:"f",value:0}}]),v.uniforms=z.current,v.vertexShader=Re,v.fragmentShader=Ie},n.startTransition(()=>{x.current=new re(32,128,128),s.current=new te(x.current,b.current),s.current.position.z=0,s.current.modifier=Math.random(),l.current.add(s.current)}),()=>{ie(l.current),oe(r.current)}},[]),n.useEffect(()=>{const o=new ce(16777215,c==="light"?1.8:2),u=new se(16777215,c==="light"?2.7:.4);return o.position.z=200,o.position.x=100,o.position.y=100,y.current=[o,u],y.current.forEach(v=>l.current.add(v)),()=>{ae(y.current)}},[c]),n.useEffect(()=>{const{width:o,height:u}=_,v=u+u*.3;r.current.setSize(o,v),i.current.aspect=o/v,i.current.updateProjectionMatrix(),m&&r.current.render(l.current,i.current),o<=L.mobile?(s.current.position.x=14,s.current.position.y=10):o<=L.tablet?(s.current.position.x=18,s.current.position.y=14):(s.current.position.x=22,s.current.position.y=16)},[m,_]),n.useEffect(()=>{const o=le(u=>{const v={x:u.clientX/window.innerWidth,y:u.clientY/window.innerHeight};P.set(v.y/2),w.set(v.x/2)},100);return!m&&d&&window.addEventListener("mousemove",o),()=>{window.removeEventListener("mousemove",o)}},[d,m,P,w]),n.useEffect(()=>{let o;const u=()=>{o=requestAnimationFrame(u),z.current!==void 0&&(z.current.time.value=5e-5*(Date.now()-h.current)),s.current.rotation.z+=.001,s.current.rotation.x=P.get(),s.current.rotation.y=w.get(),r.current.render(l.current,i.current)};return!m&&d?u():r.current.render(l.current,i.current),()=>{cancelAnimationFrame(o)}},[d,m,P,w]),e.jsx(S,{in:!0,timeout:3e3,nodeRef:f,children:({visible:o,nodeRef:u})=>e.jsx("canvas",{"aria-hidden":!0,className:Ve.canvas,"data-visible":o,ref:u,...t})})};function Ce({id:t,sectionRef:c,scrollIndicatorHidden:h,...f}){const{theme:a}=G(),{disciplines:r}=j,[i,l]=n.useState(0),y=fe(a),z=[r.slice(0,-1).join(", "),r.slice(-1)[0]].join(", and "),b=r.find((d,_)=>_===i),x=`${t}-title`,s=W();B(),ge(()=>{const d=(i+1)%r.length;l(d)},5e3,a),n.useEffect(()=>{y&&y!==a&&l(0)},[a,y]);const m=d=>{d.preventDefault(),s(d.currentTarget.href)};return e.jsx(H,{className:p.intro,as:"section",ref:c,id:t,"aria-labelledby":x,tabIndex:-1,...f,children:e.jsx(S,{in:!0,timeout:3e3,children:({visible:d,status:_})=>e.jsxs(e.Fragment,{children:[e.jsx(n.Suspense,{children:e.jsx(Ne,{})}),e.jsxs("header",{className:p.text,children:[e.jsx("h1",{className:p.name,"data-visible":d,id:x,children:e.jsx(F,{text:j.name,delay:500})}),e.jsxs(R,{level:0,as:"h2",className:p.title,children:[e.jsx(I,{className:p.label,children:`${j.role} + ${z}`}),e.jsxs("span",{"aria-hidden":!0,className:p.row,children:[e.jsx("span",{className:p.word,"data-status":_,style:V({delay:N.base.durationXS}),children:j.role}),e.jsx("span",{className:p.line,"data-status":_})]}),e.jsx("div",{className:p.row,children:r.map(P=>e.jsx(S,{unmount:!0,in:P===b,timeout:{enter:3e3,exit:2e3},children:({status:w,nodeRef:o})=>e.jsx("span",{"aria-hidden":!0,ref:o,className:p.word,"data-plus":!0,"data-status":w,style:V({delay:N.base.durationL}),children:P})},P))})]})]}),e.jsx(M,{to:"/#personal-projects",className:p.scrollIndicator,"data-status":_,"data-hidden":h,onClick:m,children:e.jsx(I,{children:"Scroll to projects"})}),e.jsxs(M,{to:"/#personal-projects",className:p.mobileScrollIndicator,"data-status":_,"data-hidden":h,onClick:m,children:[e.jsx(I,{children:"Scroll to projects"}),e.jsx("svg",{"aria-hidden":!0,stroke:"currentColor",width:"43",height:"15",viewBox:"0 0 43 15",children:e.jsx("path",{d:"M1 1l20.5 12L42 1",strokeWidth:"2",fill:"none"})})]})]})},a)})}const De="_profile_l7obs_1",ke="_content_l7obs_75",Me="_column_l7obs_101",Te="_title_l7obs_119",Ee="_description_l7obs_141",He="_tag_l7obs_161",Fe="_tagText_l7obs_187",Ge="_image_l7obs_231",Ae="_svg_l7obs_241",Ue="_button_l7obs_273",$e="_buttonGroup_l7obs_293",qe="_pdfViewer_l7obs_325",We="_pdfFrame_l7obs_345",g={profile:De,content:ke,column:Me,title:Te,description:Ee,tag:He,tagText:Fe,image:Ge,svg:Ae,button:Ue,buttonGroup:$e,pdfViewer:qe,pdfFrame:We},Be=({visible:t,titleId:c})=>e.jsxs(n.Fragment,{children:[e.jsx(R,{className:g.title,"data-visible":t,level:3,id:c,children:e.jsx(F,{text:"Hi there",start:t,delay:500})}),e.jsxs(U,{className:g.description,"data-visible":t,size:"l",as:"p",children:["I’m Diana, a Game & VR Developer and a senior computer engineer student at the ",e.jsx("strong",{children:"German University in Cairo (GUC)"}),". My portfolio includes some of the ",e.jsx("strong",{children:"professional projects"})," I have worked on, as well as ",e.jsx("strong",{children:"games"})," I have developed during ",e.jsx("strong",{children:"game jams"})," in my free time. I have also some experience with web development and machine learning. If you’re interested in the tools and software I use check out my ",e.jsx(ue,{href:"/uses",children:"uses page"}),". Feel free to check my CV below."]})]}),Oe=({id:t,visible:c,sectionRef:h})=>{const[f,a]=n.useState(!1),r=`${t}-title`;return e.jsx(H,{className:g.profile,onFocus:()=>a(!0),onBlur:()=>a(!1),as:"section",id:t,ref:h,"aria-labelledby":r,tabIndex:-1,children:e.jsx(S,{in:c||f,timeout:0,children:({visible:i,nodeRef:l})=>e.jsxs("div",{className:g.content,ref:l,children:[e.jsx("div",{className:g.column,children:e.jsxs("div",{className:g.tag,"aria-hidden":!0,children:[e.jsx(de,{notchWidth:"64px",notchHeight:"8px",collapsed:!i,collapseDelay:1e3}),e.jsx("br",{}),e.jsx("div",{className:g.tagText,"data-visible":i,children:"About me"})]})}),e.jsxs("div",{className:g.column,children:[e.jsx(Be,{visible:i,titleId:r}),e.jsxs("div",{className:g.buttonGroup,"data-visible":i,children:[e.jsx(C,{secondary:!0,className:g.button,"data-visible":i,href:"/portfolio/Diana-Rehan-CV.pdf",icon:"download",download:"Diana-Rehan-CV.pdf",children:"Download CV"}),e.jsx(C,{secondary:!0,className:g.button,"data-visible":i,href:"/portfolio/Diana-Rehan-CV.pdf",target:"_blank",icon:"link",children:"View CV"})]}),e.jsx("div",{className:g.pdfViewer,"data-visible":i,children:e.jsx("iframe",{src:"/portfolio/Diana-Rehan-CV.pdf",title:"Diana Rehan CV",className:g.pdfFrame})})]})]})})})},Xe="_home_16hv7_1",Ye="_sectionHeader_16hv7_9",E={home:Xe,sectionHeader:Ye},vn=()=>[{rel:"prefetch",href:"/draco/draco_wasm_wrapper.js",as:"script",type:"text/javascript",importance:"low"},{rel:"prefetch",href:"/draco/draco_decoder.wasm",as:"fetch",type:"application/wasm",importance:"low"}],pn=()=>q({title:"XR & Game Developer",description:`Portfolio of ${j.name} — a VR/XR developer and game developer working on immersive experiences.`}),xn=()=>{const[t,c]=n.useState([]),[h,f]=n.useState(!1),a=n.useRef(),r=n.useRef(),i=n.useRef(),l=n.useRef();return n.useEffect(()=>{const y=[a,r,i,l],z=new IntersectionObserver((x,s)=>{x.forEach(m=>{if(m.isIntersecting){const d=m.target;if(s.unobserve(d),t.includes(d))return;c(_=>[..._,d])}})},{rootMargin:"0px 0px -10% 0px",threshold:.1}),b=new IntersectionObserver(([x])=>{f(!x.isIntersecting)},{rootMargin:"-100% 0px 0px 0px"});return y.forEach(x=>{z.observe(x.current)}),b.observe(a.current),()=>{z.disconnect(),b.disconnect()}},[t]),e.jsxs("div",{className:E.home,children:[e.jsx(Ce,{id:"intro",sectionRef:a,scrollIndicatorHidden:h}),e.jsx("div",{className:E.sectionHeader,children:e.jsx(R,{level:2,as:"h2",align:"center",children:"Professional Work"})}),e.jsx(D,{id:"work-projects",sectionRef:r,visible:t.includes(r.current),index:1,title:"Dental VR Simulator Prototype",description:"An immersive VR training simulator for dental procedures, providing hands-on practice in a safe virtual environment.",videoId:"rVsoI9lu_0M",buttonText:"View Details",buttonLink:"/projects/dental-vr"}),e.jsx(D,{id:"vr-project-2",alternate:!0,sectionRef:i,visible:t.includes(i.current),index:2,title:"Pilot Training VR Simulator",description:"A comprehensive VR flight training system designed to prepare pilots to master jet engine mechanics and aircraft systems.",videoId:"zRXndIMaAxU",buttonText:"View Details",buttonLink:"/projects/pilot-vr"}),e.jsx(Oe,{sectionRef:l,visible:t.includes(l.current),id:"details"}),e.jsx($,{})]})};export{xn as default,vn as links,pn as meta};
